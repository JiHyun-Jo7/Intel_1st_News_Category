...
# # 각 카테고리 별 총 페이지 수
# pages = [146, 328, 461, 75, 117, 72]
# # 학습을 위해 최대 페이지를 중간 지점인 110 페이지로 제한함
...
for i in range(6):
    ...
    df_titles = pd.concat([df_titles, df_section_title], ignore_index=False)
df_titles.to_csv('./crawling_data/crawling_data.cvs')
